...
HIGH_CONFIDENCE = CoinSelectionCriteria(
...
MODERATE_CONFIDENCE = CoinSelectionCriteria(
...
UNDECIDED = CoinSelectionCriteria(
...
LITTLE_CONFIDENCE = CoinSelectionCriteria(
...
NO_CONFIDENCE = CoinSelectionCriteria(
