...
INVESTOR_APP_INTEGRATION = os.environ.get("INVESTOR_APP_INTEGRATION")
...
INVESTOR_APP_DB_PATH = f"{INVESTOR_APP_PATH}app.db"
INVESTOR_APP_DB_CONNECTION = f"sqlite:///{INVESTOR_APP_DB_PATH}"
